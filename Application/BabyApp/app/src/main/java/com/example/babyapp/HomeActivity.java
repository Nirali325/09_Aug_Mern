...
//                   startActivity(new Intent(HomeActivity.this,HomeActivity.class));
        ...
        gameLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (selectedTab != 3){
                    startActivity(new Intent(HomeActivity.this,QuestionGame.class));
                    homeTxt.setVisibility(View.GONE);
                    activityTxt.setVisibility(View.GONE);
                    storyTxt.setVisibility(View.GONE);
        ...
        storyLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (selectedTab != 4){
                    ...
                    startActivity(new Intent(HomeActivity.this,Stories.class));
                    homeTxt.setVisibility(View.GONE);
                    activityTxt.setVisibility(View.GONE);
                    gameTxt.setVisibility(View.GONE);
        ...
        CardView A_card = findViewById(R.id.activityCard);
        ...
        CardView G_card = findViewById(R.id.TaskCard);
        ...
        CardView S_card = findViewById(R.id.StoryCard);
